...
function mostrarModuloEspecifico(moduloId) {
    ...
    if (bloqueObjetivo) {
        ...
        // Ejecutamos el scroll suave directo hacia el bloque correspondiente
        setTimeout(() => {
...
// ==========================================================================
// CONTROLADOR DE SUB-PESTAÑAS INTERNAS PARA SEGUIMIENTO DETALLADO
// ==========================================================================
// ==========================================================================
